...
export type ThemeVariant = 'Orange' | 'Blue' | 'Green' | 'Rose' | 'Zinc' | 'Headspace'
...
> = {
  ...
  Headspace: {
    light: {
      ...
      foreground: '60 3% 17%',
      card: '0 0% 100%',
      cardForeground: '60 3% 17%',
      popover: '0 0% 100%',
      popoverForeground: '60 3% 17%',
      primary: '23 100% 50%',
      primaryForeground: '0 0% 98%',
      secondary: '213 100% 47%',
      secondaryForeground: '0 0% 98%',
      muted: '39 20% 87%',
      mutedForeground: '35 4% 38%',
      accent: '48 100% 50%',
      accentForeground: '60 3% 17%',
      destructive: '0 84.2% 60.2%',
      destructiveForeground: '0 0% 98%',
      border: '35 19% 75%',
      input: '35 19% 75%',
    ...
    dark: {
      ...
      popoverForeground: '0 0% 98%',
      primary: '0 0% 98%',
      primaryForeground: '60 3% 17%', 
      secondary: '43 7% 26%',
      secondaryForeground: '0 0% 98%',
      muted: '43 7% 26%',
      mutedForeground: '30 17% 64%',
      accent: '48 100% 50%',
      accentForeground: '0 0% 98%',
      destructive: '0 62.8% 30.6%',
      destructiveForeground: '0 0% 98%',
...
export default function setGlobalTheme(
  ...
  const theme = themes[themeVariant][themeMode] as {
    [key: string]: string
  }
